...
export default function FeaturesBlock({ data, onUpdate }: FeaturesBlockProps) {
    ...
    <div className="w-full py-16 px-10 bg-primary border-y border-nickel/10">
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8" dir="rtl">
        {data.items.map((item, i) => {
          ...
          return (
            <div key={i} className="p-6 rounded-2xl bg-slate/30 border border-nickel/20 hover:border-accent/30 transition-all flex flex-col gap-4">
